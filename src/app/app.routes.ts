...
export const routes: Routes = [
    ...
    {path: 'insurance/:carId', component: InsuranceComponent, canActivate: [authGuard] },
    {path: 'insurance/:carId/:insuranceId', component: InsuranceComponent, canActivate: [authGuard] },
    {path: 'insurance-form/:carId', component: InsuranceFormComponent, canActivate: [authGuard] },
    {path: 'insurance-form/:carId/:insuranceId', component: InsuranceFormComponent, canActivate: [authGuard] },
    ...
    {path: 'fuel-form/:carId', component: FuelFormComponent, canActivate: [authGuard] },
    {path: 'fuel-form/:fuelId', component: FuelFormComponent, canActivate: [authGuard] },
    {path: 'car/:carId/fuel', component: FuelComponent, canActivate: [authGuard] },
    {path: 'car/:carId/fuel-details/:fuelId', component: FuelDetailsComponent, canActivate: [authGuard] },
    {path: 'car/:carId/fuel-form', component: FuelFormComponent, canActivate: [authGuard] },
    {path: 'car/:carId/fuel-form/:fuelId', component: FuelFormComponent, canActivate: [authGuard] },
    {path: 'notes', component: NotesComponent, canActivate: [authGuard] },
    {path: 'notes/:carId', component: NotesComponent, canActivate: [authGuard] },
    {path: 'notes-details/:carId/:noteId', component: NotesDetailsComponent, canActivate: [authGuard] },
